...
class OthelloNNet():
    def __init__(self, game, args):
        ...
        # Neural Net
        self.input_boards = Input(shape=(self.board_x, self.board_y, 3))    # s: batch_size x board_x x board_y

        x_image = Reshape((self.board_x, self.board_y, 3))(self.input_boards)                # batch_size  x board_x x board_y x 1
