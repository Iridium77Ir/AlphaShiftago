...
class ExtremeShiftagoGame():
        ...
        if num >= 28:
            ...
            if num//7 == 0:
                if self.checkCol(num%7) == False:
                    print('Forked up ', num, self.board)
                    raise Exception('You forked up')
                    return False
                else:
    ...
    def checkScores(self):
        if self.scores[0] >= 10:
            #print('Won 1 because scores higher', self.scores)
            return 1
            ...
            if self.scores[0] > self.scores[1]:
                #print('Won 1 because scores higher and board full', self.scores)
                return 1
